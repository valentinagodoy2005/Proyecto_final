...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-08-2024 a las 00:10:49
...
(22, 'Musica', 'Wos', '		   Valentín Oliva1​ (Chacarita, Buenos Aires, 23 de enero de 1998), conocido artísticamente como Wos (estilizado como WOS o WOS DS3), es un cantante, músico, actor y freestyler argentino.\r\n\r\nSurgió en la escena de las batallas de rap entre raperos de Freestyle, y fue campeón en varias ocasiones de la competencia argentina El Quinto Escalón,2​ que lo llevó a ser uno de los artistas urbanos más reconocidos del país. Además fue campeón de la FMS Argentina 2018 y de la Red Bull Batalla Internacional 2018,3​4​ al vencer al rapero Aczino en Buenos Aires, tras haber sido subcampeón de la edición anterior frente al mismo en México.', '', 0, '', '', 1, '', '		   \r\nWos nació el 23 de enero de 1998 en el barrio porteño de Villa Crespo, Trapero, hijo de Alejandro Oliva, artista musical y fundador del grupo La Bomba del Tiempo, y de Maia Mónaco, cantante (con dos discos publicados, Cosmos y Raíz). Debido a la fuerte influencia artística de sus padres, durante su infancia estudió piano y batería, además de actuación en Escuela Metropolitana de Arte Dramático (EMAD). Culminó sus estudios secundarios en el colegio Mariano Acosta.7​', '		   ', ''),
(23, 'Musica', 'Maria Becerra', '		   María de los Ángeles Becerra, conocida como María Becerra, es una cantante, compositora y exyoutuber argentina.​En 2015 comenzó a crear contenido de entretenimiento en su canal de YouTube, el cual contó con más de tres millones de suscriptores. Con ello logró ganar varios premios y protagonizar una obra de teatro.', 'maria.jpg', 0, '', '', 1, '', '		   ', '		   ', '');
...
(11, 'lp', 'rweqtew', '2024-06-13 22:16:09'),
(12, 'lp', 'hola mundo', '2024-06-13 22:22:05');
...
(45, 'Godoy', 'jfdhguf', '', '2021', 'español', '', '', '', '', 'Audio'),
(46, 'Godoy', 'jfdhguf', '', '2021', 'español', '', '', '', '', 'Audio'),
(47, 'Godoy', 'Tarea 4', '', '2021', 'español', 'bhf', 'hbj', 'jgbju', '', 'Audio');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `libro_i`
--

CREATE TABLE `libro_i` (
  `id` int(20) NOT NULL,
  `id_material_impreso` int(20) NOT NULL,
  `autor` int(30) NOT NULL,
  `titulo` int(30) NOT NULL,
...
--
-- Volcado de datos para la tabla `libro_i`
--

INSERT INTO `libro_i` (`id`, `id_material_impreso`, `autor`, `titulo`, `edicion`, `anio`, `origen`, `tipo`, `area`, `materia`, `comentario`, `archivo`) VALUES
(3, 3, 0, 0, 0, '1944', 'inglaterra', '', '', '', 'demian.pdf', ''),
(4, 4, 0, 0, 0, '1943', 'Ingles', '', '', '', 'Hermann Hesse - El lobo estepa', ''),
(6, 6, 0, 0, 0, '1943', 'Frances', '', '', '', 'Spinetta.pdf', ''),
(7, 7, 0, 0, 0, '', '', '', '', '', 'Arthur Conan Doyle - El Mundo ', 'Libro'),
(9, 9, 0, 0, 0, '', '', '', '', '', '', 'Libro'),
(10, 10, 0, 0, 0, '', '', '', '', '', 'Capek, Karel-La Guerra De Las ', 'Libro'),
(11, 11, 0, 0, 0, '', '', '', '', '', 'Huxley, Aldous - Contrapunto.p', 'Libro'),
(12, 12, 0, 0, 0, '', '', '', '', '', 'Lem, Stanislaw - El Invencible', 'Libro'),
(13, 13, 0, 0, 0, '', '', '', '', '', 'Huxley, Aldous-Las puertas de ', 'Libro'),
(15, 15, 0, 0, 0, '2016', 'Español', 'Informatica', 'programacion', '', 'php_poo.docx', 'Otros'),
(16, 16, 0, 0, 0, '', 'Español', 'Literatura', '', '', 'Bach, Richard - Juan Salvador ', 'Libro'),
(17, 17, 0, 0, 0, '', 'Español', '', '', '', 'Greene, Graham-Nuestro Hombre ', 'Libro'),
(20, 20, 0, 0, 0, '', '', '', '', '', 'Frank, Ana - Diario.pdf', 'Libro');
...
CREATE TABLE `prestamos` (
  `id_material_impreso` int(11) NOT NULL,
  `id` int(11) NOT NULL,
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
